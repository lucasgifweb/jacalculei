...
defined('UNLIMITED_ELEMENTS_INC') or die('Restricted access');
	...
	class UniteFunctionsWPUC{
		 ...
		 * get taxanomy query
		 */
		public static function getPosts_getTaxQuery($category, $categoryRelation = null, $isIncludeChildren = false){
		...
		public static function getPostsArgs($filters){
			...
			$arrTax = self::getPosts_getTaxQuery($category, $categoryRelation, $categoryIncludeChildren);
