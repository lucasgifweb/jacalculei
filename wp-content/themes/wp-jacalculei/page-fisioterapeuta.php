...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M63KXF2"
    ...
    <!-- Start Main Banner -->
    <div class="main-banner item-bg-nine">
            ...
            <div class="row">
              <div class="col-lg-8 col-md-12">
                <div class="main-banner-text-internal">
                  <h1 class="title_internal"><span class="span_no_block">A</span> contabilidade para fisioterapeutas <span class="span_no_block">com eficiência, rapidez e confiança!</span></h1>
                  <p class="font_price_small">Mensalidades a partir de <span class="price">R$ 89,90</span></p>
                  <ul class="list-internal-services">
                    <li><i class="fa fa-check"></i>Fazemos a abertura gratuita da sua empresa para você focar na sua atividade.</li>
                    <li><i class="fa fa-check"></i>Tenha mais tranquilidade nos negócios contando com a nossa expertise em <b>gestão de contabilidade</b>.</li>
                    <li><i class="fa fa-check"></i>Nossa <b>plataforma de contabilidade</b> para fisioterapeutas proporciona recursos e ferramentas online para manter sua rotina contábil simplificada.</li>
                  </ul>
