...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M63KXF2"
    ...
    <!-- Start Main Banner -->
    <div id="home" class="main-banner item-bg-three">
            ...
            <div class="row">
              <div class="col-lg-12 col-md-12">
                <div class="main-banner-text">
                  <h1 class="no-margin">Confira Os Planos e Preços Da Contabilidade Online <span>Já Calculei</span></h1> 
                  <p>Somos contadores, temos um atendimento <br> excelente e sua empresa fica sempre em dia.</p>
                  <a href="{% url 'chatbot' %}" class="btn btn-primary">Contrate Agora</a>
