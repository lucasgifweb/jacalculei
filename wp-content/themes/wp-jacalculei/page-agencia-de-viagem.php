<?php get_header();
/**
* Template Name: Agência de viagens
*
* @package WordPress
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M63KXF2"
    ...
    <!-- Start Main Banner -->
    <div class="main-banner item-bg-twelve">
            ...
            <div class="row">
              <div class="col-lg-8 col-md-12">
                <div class="main-banner-text-internal">
                  <h1 class="title_internal"><span class="span_no_block">Gerenciamos a</span> contabilidade para Agências de Viagem <span class="span_no_block">com muita eficiência e comodidade</span></h1>
                  <p class="font_price_small">Mensalidades a partir de <span class="price">R$ 89,90</span></p>
                  <ul class="list-internal-services">
                    <li><i class="fa fa-check"></i>Asseguramos a abertura da sua empresa de forma rápida e gratuita.</li>
                    <li><i class="fa fa-check"></i>Foque no crescimento de sua empresa e deixe que nós <b>organizamos sua contabilidade para você!</b></li>
                    <li><i class="fa fa-check"></i>Somos uma <b>plataforma de contabilidade</b> para agências de viagens que oferece amplos recursos e ferramentas online.</li>
                  </ul>
