...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M63KXF2"
    ...
    <!-- Start Main Banner -->
    <div class="main-banner item-bg-teen">
            ...
            <div class="row">
              <div class="col-lg-8 col-md-12">
                <div class="main-banner-text-internal">
                  <h1 class="title_internal">Jornalistas,<span class="span_no_block"> nós cuidamos  da sua contabilidade</span></h1>
