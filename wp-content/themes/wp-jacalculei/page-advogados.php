...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M63KXF2"
    ...
    <!-- Start Main Banner -->
    <div class="main-banner item-bg-four">
            ...
            <div class="row">
              <div class="col-lg-8 col-md-12">
                <div class="main-banner-text-internal">
                  <h1 class="title_internal">Contabilidade para Advogados<span class="span_no_block">, organize a parte contábil de seu escritório</h1>
                    <p class="font_price_small">Mensalidades a partir de <span class="price">R$ 89,90</span></p>
                    <ul class="list-internal-services">
                      <li><i class="fa fa-check"></i>Fazemos a abertura da sua empresa de forma gratuita.</li>
                      <li><i class="fa fa-check"></i>Tenha mais tempo para prospectar e atender clientes deixando sua contabilidade em nossas mãos!</li>
                      <li><i class="fa fa-check"></i>Uma contabilidade especializada no atendimento do setor jurídico com a facilidade das ferramentas online.</li>
                    </ul>
