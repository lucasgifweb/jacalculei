...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M63KXF2"
    ...
    <!-- Start Main Banner -->
    <div class="main-banner item-bg-eleven">
            ...
            <div class="row">
              <div class="col-lg-8 col-md-12">
                <div class="main-banner-text-internal">
                  <h1 class="title_internal"><span class="span_no_block">A</span> Contabilidade para Médicos <span class="span_no_block">com a qualidade que você precisa!</span></h1>
                  <p class="font_price_small">Mensalidades a partir de <span class="price">R$ 89,90</span></p>
                  <ul class="list-internal-services">
                    <li><i class="fa fa-check"></i>Abrimos sua empresa gratuitamente.</li>
                    <li><i class="fa fa-check"></i>Conte com a Já Calculei para gerenciar sua contabilidade com praticidade e organização.</li>
                    <li><i class="fa fa-check"></i>A Já Calculei ajuda você, médico, a cumprir com todas as suas obrigações legais.</li>
                  </ul>
