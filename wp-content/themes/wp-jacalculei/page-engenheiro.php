...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M63KXF2"
    ...
    <!-- Start Main Banner -->
    <div class="main-banner item-bg-eight">
            ...
            <div class="row">
              <div class="col-lg-8 col-md-12">
                <div class="main-banner-text-internal">
                  <h1 class="title_internal">Contabilidade para engenheiros <span class="span_no_block">com planejamento e redução de impostos</span></h1>
                  <p class="font_price_small">Mensalidades a partir de <span class="price">R$ 89,90</span></p>
                  <ul class="list-internal-services">
                    <li><i class="fa fa-check"></i>Abrimos sua empresa sem custo adicional!</li>
                    <li><i class="fa fa-check"></i>Gerenciamos a contabilidade de sua empresa de engenharia com a máxima eficiência.</li>
                    <li><i class="fa fa-check"></i>ferecemos uma <b>plataforma de contabilidade</b> completa, com recursos e ferramentas online para simplificar sua rotina contábil.</li>
                  </ul>
